# Jakub B. (initials J.P.B.) - preferred pronouns: he/him, they/them
...
I have a copule defining traits, such as stubbornly trying to force something to succeed (as seen in me rebasing CaesiumOS thousands of times to try to get a sustainable build environment for it) and spontaneously saying some of the weirdest (often hilariously funny) things ever.

TL;DR: Some incerdibly funny, determined person.
...
Though the moment that really propelled me into the Android platform development spece happened in Jaunary 2020, when I got my Redmi Note 8 (ginkgo), which I use ever since then.
...
Ever since then I've been continually attemtping to release builds, having eventually moved my focus away from the AVD and onto actual devices (though I have plans to compile for the AVD again at some stage).
...
I took that principle and applied it to _typing_. This means there are two modes: rich text/RTF editing and code editing (using Scintilla, the same code editor powering Notepad++), with Markdown editing coming in the near future.
...
The motivation for this was the discontinuation of kernel 5.4, which my Redmi Note 11 Pro 5G, as well as the OnePlus Nord N200 5G and Motorola G Stylus 5G 2022 rely on.
### BetterAbout
